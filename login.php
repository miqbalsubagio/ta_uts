    ...
    >
      <div class="container">
        <a href="index.php" class="navbar-brand" title="home">
          <img src="assets/images/logopaling.png" class="w-50" alt="logo" />
        </a>
        <button
        ...
        <div class="container">
          <div class="row align-items-center row-login">
            <div class="col-lg-6 text-center">
              <img
                src="assets/images/marketing-automation-ecommerce-fashion.png"
                alt=""
    ...
    <footer>
      <div class="container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">
              2020 Copyright Store by fatkha katon iqbal anisa
            </p>
          </div>
        </div>
      </div>
