...
<html lang="en">
  <head>
    ...
    <title>Toko Supplier Pakaian Bekas</title>
    ...
    >
      <div class="container">
        <a href="index.php" class="navbar-brand" title="home">
          <img src="assets/images/jon.png" class="w-50" alt="logo" />
        </a>
        <button
      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            <div class="col-md-5">
              <img src="assets/images/jon1.png" class="w-100" alt=""/>
            </div>
            <div class="col-md-6">
              <h1 style="font-weight: bold; margin-bottom: 15px;">Ortosec</h1>
              <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
               ORTOSEC merupakan tempat penjualan pakian bekas import yang berkualitas
              </p>
                  ...
                  <div class="row justify-content-center align-content-center">
                    <div class="col-10 col-md-4">
                      <div class="adventeges-thumbnail mb-lg-0 mb-2">
                        <img
                          src="assets/images/terjamin.png"
                          class="w-100"
                          alt=""
                        />
                      </div>
                    ...
                    <div class="col-md-8">
                      ...
                      >
                        <div class="title-text">Kualitas Terjamin</div>
                        <div class="subtitle-text">
                          Kami sudah memilih barang berkualitas
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text">Pasti Sampai</div>
                        <div class="subtitle-text">
                          Kami sudah terdaftar sebagai resmi
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    <div class="col-10 col-md-4">
                      <div class="adventeges-thumbnail mb-lg-0 mb-2">
                        <img src="assets/images/ori.png" class="w-100" alt="" />
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div
                        class="adventege-description text-center text-lg-left"
                      >
                        <div class="title-text">Original</div>
                        <div class="subtitle-text">
                          Barang sudah terjadin original
                        </div>
                      </div>
                    </div>
                  </div>
