        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <h5 class="">Toko Pakain Bekas Import</h5>
              <a
                  href="https://wa.me/6285726803021"
                  target="_blank"
      ...
      <section class="store-adventeges" id="adventeges">
        <div class="container">
          <div class="row text-center">
            <div class="col-12">
              <h2 class="font-weight-bold mb-2">ORTOSEC</h2>   
              <hr style="border-top: 5px solid black; width: 80px;">
            </div>
          </div>
          <div class="row text-center">
            <div class="col-md-12">
              <p>ORTOSEC MERUPAKAN TEMPAT PAKIAN BEKAS TERBAIK</p>
            </div>
          </div>
          ...
          <div class="row justify-content-center text-center">
            <div class="col-md-6">
                <h5>Visi</h5>
                <p>Menjadi perusahaan pakaian terbaik seindonesia yang akan menghasilkan layanan serta produk berkualitas tinggi</p>
            </div>
            <div class="col-md-6">
                <h5>Misi</h5>
                <p>Meningkatkan daya saing industri pakaian bekas dan berusaha mengurangi pengangguran dan kemiskinan</p>
            </div>
          </div>
        </div>
      </section>
